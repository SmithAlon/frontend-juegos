    ...
    <div className="min-h-screen flex flex-col">        <TextProcessor />
      <footer className="text-center text-gray-400 p-2 mt-auto">  
        <div className='flex flex-col items-center mb-2'>
          <a href="https://github.com/SmithAlon/RapidRead" target="_blank" rel="noopener noreferrer" className='text-lg text-center text-white'>
            Si estás interesado por la programación. <span className='underline underline-offset-1'>Da click</span>
          </a>
        </div>
